    ...
    <div className="mx-auto max-w-5xl px-4 py-10">
      <header className="mb-10">
        ...
        <p className="mt-3 text-ocean-600 leading-relaxed max-w-2xl">
          ...
          they run — <span className="font-medium text-amber-800">AKS</span> (cluster nodes) vs{" "}
          <span className="font-medium text-violet-800">Function</span> (order-webhook) — so you
